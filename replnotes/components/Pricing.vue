    ...
    <div class="bg-gray-800">
        <div class="pt-12 sm:pt-16 lg:pt-24">
            <div class="max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8">
                <div class="max-w-3xl mx-auto space-y-2 lg:max-w-none">
                    <p
                        class="text-3xl font-bold text-white sm:text-3xl lg:text-4xl"
                    >
                        Pricing
                    </p>
                </div>
        ...
        <div class="mt-8 pb-12 bg-gray-200 sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
            <div class="relative">
                ...
                <div
                    class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
                >
                    <div
                    ...
                    >
                        ...
                        >
                            <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                                ...
                                <div
                                    class="mt-4 flex items-baseline text-6xl font-extrabold"
                                >
                                    $0
                                    <span
                                        class="ml-1 text-2xl font-medium text-gray-500"
                                    >
                                    </span>
                                </div>
                        ...
                        >
                            <div class="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                                ...
                                <p class="mt-5 text-lg text-gray-500">
                                    There is currently no paid plan.
                                </p>
                            </div>
                            <div
                                class="flex-1 flex flex-col justify-between px-6 pt-6 pb-8 bg-gray-50 space-y-6 sm:p-10 sm:pt-6"
                            >
                                <ul class="space-y-4">
                                    ...
                                    <li class="flex items-start">
                                        ...
                                        <p class="ml-3 text-base text-gray-700">
                                            Upload and manage assets - images,
                                            videos, HTML
                                        </p>
                                    </li>
                                ...
                                >
                                    <p
                                        class="mt-6 text-lg font-medium text-indigo-700"
                                    >
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <button
                                            type="submit"
                                            @click="notify"
                                            class="w-full mt-3 inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-md font-bold rounded-md text-white hover:text-indigo-100 bg-gray-800 hover:bg-gray-900 focus:ring-4 focus:ring-gray-200 focus:bg-gray-900 disabled:opacity-50"
                                            :disabled="
