<template>
    ...
    <div>
        ...
        >
            ...
            <p
                v-if="user.location"
                class="mt-2 text-xl sm:text-2xl font-medium"
            >
                {{ user.location }}
            </p>
            ...
            >
                <h1>
                    ...
                    <span v-if="Object.values(user.posts).length > 1"
                        >posts</span
                    >
        ...
        <div
            class="my-6 flex items-center justify-center lg:justify-start space-x-8"
        >
            <a
                class="link"
