      ...
      >
        ...
        >
          ...
          >
            ...
            <button type="button" tabindex="-1" @click="removeSelected(index)">
...
export default {
  ...
  computed: {
    ...
    filteredSuggest() {
      ...
      const newTerm = this.allowInsertionOfNewKeys
  ...
  methods: {
    ...
    traverseList(direction) {
      ...
      const newIndex =
        direction === 'next' ? this.activeVertical + 1 : this.activeVertical - 1
